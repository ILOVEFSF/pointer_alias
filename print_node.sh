...
# $1为AST文件名称。
# $2: 节点编号。
# $3: 打印方向，取值为LR|RL|BT，分别表示按从left-to-right，right-to-left,bottom-to-top的方向画图，省略则表示从top-to-bottom。
...
if [ -z $rank ]
then
	dot -Nfontsize=10 -Tjpg tmp -o ${f}_${node}.jpg   
else
